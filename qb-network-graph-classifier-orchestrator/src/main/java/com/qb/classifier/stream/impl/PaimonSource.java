 ...
 * Implements {@link EntityConnectionSource} for DI.
 */
public class PaimonSource implements EntityConnectionSource {
    ...
    public PaimonSource(Config config) throws Exception {
        this.config = config;
    ...
    @Override
    public int readAll(Consumer<EntityConnection> processor) throws Exception {
    ...
    @Override
    public void streamChanges(Consumer<EntityConnection> processor) throws Exception {
        ReadBuilder readBuilder = table.newReadBuilder();
