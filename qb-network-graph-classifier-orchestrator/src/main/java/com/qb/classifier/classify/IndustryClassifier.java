...
/**
 * Maps free-text category → NAICS code.
 *
 * Multi-strategy lookup:
 *   1. Exact match on lowered category
 *   2. Token-based keyword match
 *   3. Substring containment check
 *
 * The lookup table is built from the seed generator's VENDOR_CATEGORIES
 * and CLIENT_CATEGORIES — the same data that populated MySQL.
 */
public final class IndustryClassifier {
     ...
     */
    public static Result classify(String category) {
