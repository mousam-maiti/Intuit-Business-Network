 ...
 *   VERY_HIGH > $1,000,000
 */
public class BehavioralClassifier implements Classifier<BehavioralClassifier.Result> {
    ...
    public Result classify(EntityConnection input) {
        return classifyBehavior(input.totalVolume(), input.transactionCount());
    }
    ...
    /** Classify behavioral signals from volume and transaction count. */
    public static Result classifyBehavior(BigDecimal totalVolume, Long transactionCount) {
