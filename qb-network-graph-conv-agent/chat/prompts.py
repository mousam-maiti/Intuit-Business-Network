...
TOOL_LABELS = {
    "search_entities": "Looking up businesses in the network",
    "describe_entity": "Pulling up the company profile",
    "query_network": "Exploring connections in the graph",
    "aggregate_stats": "Crunching the numbers",
    "search_by_relationship": "Checking transaction relationships",
    "get_merge_history": "Reviewing entity merge history",
    "get_company_connections": "Gathering vendor and customer data",
    "query_ontology": "Classifying industry categories",
    "check_shared_context": "Comparing shared business relationships",
    "batch_industry_filter": "Filtering companies by industry",
    "traverse_supply_chain": "Walking the supply chain",
    "find_shortest_path": "Mapping the connection path between entities",
    "find_common_neighbors": "Finding shared business partners",
    "detect_cluster": "Identifying business clusters",
    "assess_risk_impact": "Evaluating downstream risk exposure",
}
