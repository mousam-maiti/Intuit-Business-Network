...
Replaces direct Python class calls (CandidateEvaluator, KnowledgeGraphServer,
EntityWriter) with MCP tool invocations over HTTP.

Usage:
    client = MCPToolClient("http://localhost:8081/mcp")
    await client.connect()
    result = await client.call_tool("find_candidates", {"orphan_persona": {...}})
"""
...
class MCPToolClient:
    ...
    async def connect(self):
        ...
        result = await self._rpc("initialize", {
            ...
            "capabilities": {},
            "clientInfo": {"name": "entity-resolution-agent", "version": "3.0.0"},
        })
    ...
    async def call_tool(self, name: str, arguments: dict) -> Any:
        ...
        Returns:
            dict for JSON results, str for plain-text results (e.g., audit IDs).
        """
